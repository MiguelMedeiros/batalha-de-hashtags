  ...
  return (
    <div className={classes.root}>
      ...
      <Text>
        ...
        <Link to={"/personagem/coxinha"}>coxinha</Link> e o{" "}
        <Link to={"/personagem/mortadela"}>sanduiche de mortadela</Link>,
        brincando com esse momento político que vivemos.
      </Text>
      <Text>
        E foi <b>juntando essas ideias que o Batalha de Hashtags</b> surgiu! Num
        estilo Street Fighter brincamos com essa dicotomia da direita e
        esquerda. Colocamos personagens representativos de cada ala para{" "}
        <b>brigar por sua hashtag no Twitter</b> e vencer a Batalha de Hashtags!
      </Text>
